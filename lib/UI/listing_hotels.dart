...
class ListingHotels extends StatefulWidget {
  @override
  _ListingHotelsState createState() => _ListingHotelsState();
}

class _ListingHotelsState extends State<ListingHotels> {
              ...
              children: <Widget>[
                IconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => ListingHotels()),
                    );
                  },
                ),
//                Text('Search'),
